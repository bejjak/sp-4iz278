<div class="d-flex w-100 justify-content-center pe-2 ps-2 flex-wrap">
    <div class="d-flex flex-column col-md-6 justify-content-start align-items-center mb-4">
        <h3 class="text-decoration-underline">Simple login</h3>
        <form class="login-form d-flex flex-column" method="POST" action="{{ route('login') }}">
            @csrf
            ...
            <div class="d-flex flex-column align-items-center justify-content-center mt-3">
                <button type="submit" class="btn btn-success mt-2 text-white mb-3">
    ...
    <div class="d-flex flex-column col-md-6 justify-content-start align-items-center">
        <h3 class="text-decoration-underline text-center">Login with social media accounts</h3>
